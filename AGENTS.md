...
state/               volatile runtime signals; gitignored
  ...
  .claude-autoarm.lock .claude-autoarm-epoch .claude-autoarm-failure-notified .claude-autoarm-failure-alarmed .turnend-claude-blocks   Claude Stop auto-arm single-flight, epoch, failure-episode, attended-alarm, and guard-budget records; never touch
