...
state/               volatile runtime signals; gitignored
  ...
  .claude-autoarm.lock .claude-autoarm-epoch .claude-autoarm-failure-notified .turnend-claude-blocks   Claude Stop auto-arm single-flight, epoch, failure-episode, and guard-budget records; never touch
