...
cursor model profile is accepted^{"rules":[{"when":"cursor work","use":{"harness":"cursor","model":"claude-opus-5-thinking-high"}}]}^empty^
unsupported cursor effort is flagged^{"rules":[{"when":"cursor work","use":{"harness":"cursor","model":"claude-opus-5-thinking-high","effort":"high"}}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - invalid effort: cursor:high
antigravity model profile is accepted^{"rules":[{"when":"antigravity work","use":{"harness":"antigravity","model":"claude-sonnet-4-6"}}]}^empty^
unsupported antigravity effort is flagged^{"rules":[{"when":"antigravity work","use":{"harness":"antigravity","model":"claude-sonnet-4-6","effort":"medium"}}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - invalid effort: antigravity:medium
